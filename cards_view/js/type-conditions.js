...

{
    ...
    document.querySelector('.condition-usage').innerHTML = card_usage;
    document.querySelector('.condition-tense').innerHTML = card_tense;
    document.querySelector('.condition-sentence-type').innerHTML = card_sentence_type;
    document.querySelector('.condition-pronoun').innerHTML = card_pronoun;
    ...
    document.querySelector('.copy-icon').addEventListener('click', () => {
        ...
        let def_line = 'definition: ' + card_def + '\n';
